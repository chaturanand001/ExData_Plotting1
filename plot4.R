...
globalReactivePower <- as.numeric(ssdata$Global_reactive_power)
voltage <- as.numeric(ssdata$Voltage)
subMetering1 <- as.numeric(ssdata$Sub_metering_1)
subMetering2 <- as.numeric(ssdata$Sub_metering_2)
subMetering3 <- as.numeric(ssdata$Sub_metering_3)
